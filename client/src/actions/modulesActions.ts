...
export const getModules = () => {
  return (dispatch: Dispatch) => {
    return fetch(`${url}`)
      ...
      .then((obj) => dispatch({ type: GET_MODULES, payload: obj }));
  };
};
...
export const createModule = (newModule: Module) => {
  return (dispatch: Dispatch) => {
    return fetch(url, {
      ...
      .then((response) => response.json())
      .then(() => dispatch({ type: CREATE_MODULE }));
  };
};
...
export const getModuleById = (id: string) => {
  return (dispatch: Dispatch) => {
    return fetch(`${url}/${id}`)
      .then((response) => response.json())
      .then((obj) => dispatch({ type: GET_MODULE_BY_ID, payload: obj }));
  };
};
...
export const deleteModuleById = (id: string) => {
  return (dispatch: Dispatch) => {
    return fetch(`${url}/${id}`, {
      ...
      .then((response) => response.json())
      .then(() => dispatch({ type: DELETE_MODULE_BY_ID }));
  };
};
...
export const updateModuleById = (id: string, updates: Module) => {
  return (dispatch: Dispatch) => {
    return fetch(`${url}/${id}`, {
      ...
      .then((response) => response.json())
      .then(() => dispatch({ type: UPDATE_MODULE_BY_ID }));
  };
};
